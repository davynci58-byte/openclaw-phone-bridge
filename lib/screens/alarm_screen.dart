...
class _AlarmScreenState extends State<AlarmScreen> {
  ...
  Widget _buildAlarmTile(BuildContext context, alarm_model.DeviceAlarm alarm) {
    return Card(
  ...
  void _showEditAlarmDialog(BuildContext context, alarm_model.DeviceAlarm alarm) {
    _showAlarmDialog(context, alarm: alarm);
  }

  void _showAlarmDialog(BuildContext context, {alarm_model.DeviceAlarm? alarm}) {
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: () async {
                      final newAlarm = alarm_model.DeviceAlarm(
                        id: alarm?.id ?? '',
